...
router.get('/employee-allocations', authorize(...MANAGE_ROLES), controller.allocationSummary);
router.get('/employee-allocations/:employeeId', authorize(...MANAGE_ROLES), controller.allocationOptions);
router.put('/employee-allocations/:employeeId', authorize(...MANAGE_ROLES), validate(validation.syncEmployeeAssetsSchema), controller.syncAllocation);
