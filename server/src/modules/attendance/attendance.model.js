...
const regularizationSchema = new mongoose.Schema({
  ...
  approvalStage: { type: String, enum: ['reporting', 'hr'] },
  reportingReviewedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Employee' },
  reportingReviewedAt: { type: Date },
  reportingRemarks: { type: String },
